    ...
    const packages = [
        {
            ...
            planetProperties: {
                ...
                planetMap: "/src/resources/globe-textures/8k_earth_daymap.jpg",
                planetNormalMap: "/src/resources/globe-textures/8k_earth_normal_map.jpg",
                planetCloudsMap: "/src/resources/globe-textures/8k_earth_clouds.jpg",
                planetSpecularMap: "/src/resources/globe-textures/8k_earth_specular_map.jpg",
            },
        ...
        },
        {
            ...
            planetColor: "#FF0000",
            planetProperties: {
                planetMap: "/src/resources/globe-textures/2k_mars.jpg",
                planetNormalMap: "",
                planetCloudsMap: "",
                planetSpecularMap: "",
            },
    ...
    return (
        ...
        >
            ...
            <Box
                ...
                <InputBase id="sample" placeholder="Search Planets" sx={{ width: "100%" }} />
                        ...
                        return (
                            <Card
                                ...
                                sx={{
                                    ...
                                    backgroundImage: `linear-gradient(180deg, ${planet.planetColor} 0%, var(--secondary-dark) 100%)`,
                                    flex: "0 0 auto"
                                }}>
                                <Canvas
                                    style={{
                                    ...
                                    <Planet planetProperties={planet.planetProperties} />
                                </Canvas>
                                ...
                                <Box
                                    ...
                                    <Typography variant="h2">MARS</Typography>
                                    <Typography variant="p">Milky Way Galaxy.</Typography>
                                </Box>
                                ...
                                <Box
                                    ...
                                    <Box
                                        ...
                                        <Stack direction="row" spacing={0.5} alignItems="center">
                                            <NearMe />
                                            <Typography variant="p">225M KM</Typography>
                                        </Stack>

                                        <Typography variant="p">From Earth</Typography>
                                    </Box>

                                    <Divider sx={{ bgcolor: "secondary.main" }} orientation="vertical" flexItem />
                                    ...
                                    <Box
                                        ...
                                        <Stack direction="row" spacing={0.5} alignItems="center">
                                            <Groups />
                                            <Typography variant="p">50 K</Typography>
                                        </Stack>
